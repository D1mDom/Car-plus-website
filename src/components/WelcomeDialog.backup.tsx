/**
 * Backup of the original welcome popup (blue header card).
 * Active popup: src/components/WelcomeDialog.tsx
 * This file is not imported — restore by copying this component into WelcomeDialog.tsx.
 */
...
export default WelcomeDialogBackup;
